...
class _HomePageState extends State<HomePage> {
  ...
  Future<Map> _getSearch() async {
    ...
    if (_search == null) {
      ...
      response = await http.get(
          'https://api.giphy.com/v1/gifs/search?api_key=PlZolrTlOobahOvXILOMUDkOjejD4sBN&q=$_search&limit=19&offset=$_offset&rating=g&lang=en');
    }
          ...
          return Container(
            child: GestureDetector(
              child: Column(
                ...
                children: <Widget>[
                  Icon(Icons.refresh, color: Colors.white, size: 70.0),
                  Text(
                    'Carregar Maiss!!',
